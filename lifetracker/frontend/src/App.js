    ...
    <div className="app-layout">
      ...
      <main className="main-content">
        <Routes>
          ...
          <Route path="/memories"      element={<PermGuard perm="memories"><Memories /></PermGuard>} />
    ...
    return (
      <div style={{ padding: 32 }}>
        <div className="card" style={{ textAlign: 'center', padding: 48 }}>
          ...
          <p style={{ color: 'var(--text2)', fontSize: 14 }}>You don't have access to this feature.<br/>
          <span style={{ color: 'var(--text3)', fontSize: 12 }}>Contact the owner to request access.</span></p>
        </div>
      </div>
    );
  }
